...
function HistorialIncidencia() {
  ...
  const emptyRows =
    rowsPerPage -
    Math.min(rowsPerPage, listaHistorial.length - page * rowsPerPage);
                ...
                <Table stickyHeader>
                  ...
                  <TableBody>
                    {listaHistorial
                      ...
                      .map((historialIncidencia, index) => (
                        <TableRow
                          key={historialIncidencia.historialIncidenciaId}
                          style={
                            index % 2
                              ? { background: "#f5f5f5" }
                              : { background: "white" }
                        ...
                        >
                          ...
                          <TableCell size="small" align="center">
                            {historialIncidencia.codigoIncidencia}
                          </TableCell>
                          <TableCell size="small" align="center">
